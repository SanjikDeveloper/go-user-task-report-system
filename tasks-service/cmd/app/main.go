...
import (
	...
	delivery "tasks-service/internal/delivery/http"
	"tasks-service/internal/repository/postgres"
	"tasks-service/pkg/config"
	"tasks-service/pkg/logger"
	service "tasks-service/pkg/services"
...
func main() {
	...
	// Инициализируем репозиторий ДО создания сервиса
